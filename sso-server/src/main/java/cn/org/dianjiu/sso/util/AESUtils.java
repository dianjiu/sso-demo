package cn.org.dianjiu.sso.util;
...
public class AESUtils {
    ...
    public static String encryptToStr(String data, String key) {
        ...
        return ObjectUtils.isNotBlank(data) ? parseByte2HexStr(encrypt(data, key)) : null;
    }
    ...
    public static String decryptToStr(String enCryptdata, String key) {
        return ObjectUtils.isNotBlank(enCryptdata) ? new String(decrypt(parseHexStr2Byte(enCryptdata), key)) : null;
    }
    ...
    public static void main(String[] args) {
        String ss = encryptToStr("734cf8b06e3c4948923137532c8d6c90", "5ee022e13d7540d684b0ec152510fcdb");
        System.out.println(ss);
        System.out.println(decryptToStr(ss, "5ee022e13d7540d684b0ec152510fcdb"));
    }
}
